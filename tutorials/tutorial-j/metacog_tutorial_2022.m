...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% * METACOGNITION TUTORIAL 2022*
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
% 
% 
% M. Rouault - Adapted from O. Faull and S. Fleming
% 
% 
% 
% *INSTRUCTIONS:*
...
% 
% _FUNCTION:_ cpc2022_type2_SDT_sim(d, noise, c, Nratings, Ntrials);

sim1.lowNoise.responses = cpc2022_type2_SDT_sim(sim1.d, sim1.noise.low, sim1.c, sim1.Nratings, sim1.Ntrials);
sim1.highNoise.responses = cpc2022_type2_SDT_sim(sim1.d, sim1.noise.high, sim1.c, sim1.Nratings, sim1.Ntrials);
%% 
% 
% 
% *Plot the confidence results for the two simulations:*
% 
% _FUNCTION:_ cpc2022_plot_confidence(data, title, type)
% 
...
subplot(1,2,1)
cpc2022_plot_confidence(sim1.lowNoise, 'LOW NOISE', 'obs');
subplot(1,2,2)
cpc2022_plot_confidence(sim1.highNoise, 'HIGH NOISE', 'obs');
%% 
% 
% 
% *EXPLANATION:*
...
sim2.dHigh.responses = cpc2022_type2_SDT_sim(sim2.dValueHigh, sim2.noise.value, sim2.c, sim2.Nratings, sim2.Ntrials);
sim2.dLow.responses = cpc2022_type2_SDT_sim(sim2.dValueLow, sim2.noise.value, sim2.c, sim2.Nratings, sim2.Ntrials);
%% 
% 
% 
% *Plot the confidence results for the two simulations:*
...
set(gcf, 'Position', [200 200 800 300])
subplot(1,2,1)
cpc2022_plot_confidence(sim2.dHigh, 'HIGHER d''', 'obs');
subplot(1,2,2)
cpc2022_plot_confidence(sim2.dLow, 'LOWER d''', 'obs');
%% 
% 
% 
% *EXPLANATION:*
...
sim3.lowNoise.responses = cpc2022_type2_SDT_sim(sim3.d, sim3.noise.low, sim3.c, sim3.Nratings, sim3.Ntrials);
sim3.highNoise.responses = cpc2022_type2_SDT_sim(sim3.d, sim3.noise.high, sim3.c, sim3.Nratings, sim3.Ntrials);
%% 
% 
% 
% *Plot the confidence results for the two simulations:*
...
set(gcf, 'Position', [200 200 800 300])
subplot(1,2,1)
cpc2022_plot_confidence(sim3.lowNoise, 'LOW NOISE', 'obs');
subplot(1,2,2)
cpc2022_plot_confidence(sim3.highNoise, 'HIGH NOISE', 'obs');
%% 
% 
% 
% *Now plot the observed type2 data in a type2ROC curve:*
% 
% _FUNCTION:_ cpc2022_plot_type2roc(data, title, type)
% 
% _NOTE:_ type = 'obs' or 'est' (observed or estimated data from model)
...
set(gcf, 'Position', [200 200 800 300])
subplot(1,2,1)
cpc2022_plot_type2roc(sim3.lowNoise, 'LOW NOISE', 'obs');
subplot(1,2,2)
cpc2022_plot_type2roc(sim3.highNoise, 'HIGH NOISE', 'obs');
%% 
% 
% 
% *EXPLANATION:*
...
% 
% _FUNCTION:_ cpc2022_calcAU_type2roc(data)

low_noise_area = cpc2022_calcAU_type2roc(sim3.lowNoise)
high_noise_area = cpc2022_calcAU_type2roc(sim3.highNoise)
%% 
% 
% 
...
% _HINTS:_
% 
%     - You can plot using: cpc2022_plot_type2roc(sim2.dHigh, 'HIGH d', 'obs')
% 
%     - You can calculate the area using: cpc2022_calcAU_type2roc(sim2.dHigh)
% 
% 
% 
% 
...
% 
% _FUNCTION:_ cpc2022_metad_sim(d, meta-d', c, Nratings, Ntrials);

sim4.lowMetad.responses = cpc2022_metad_sim(sim4.d, sim4.metad.low, sim4.c, sim4.Nratings, sim4.Ntrials);
sim4.highMetad.responses = cpc2022_metad_sim(sim4.d, sim4.metad.high, sim4.c, sim4.Nratings, sim4.Ntrials);
%% 
% 
% 
...
% and stimulus 2 (nR_S2) for each confidence level, and are generated by cpc2022_metad_sim
...
figure
cpc2022_plot_confidence(sim4.highMetad, 'HIGH META-D', 'est');
cpc2022_plot_type2roc(sim4.highMetad, 'HIGH META-D', 'est');
%% 
% 
% 
...
figure
cpc2022_plot_confidence(sim4.lowMetad, 'LOW META-D', 'est');
cpc2022_plot_type2roc(sim4.lowMetad, 'LOW META-D', 'est');
%% 
% 
% 
% *EXPLANATION:*
...
for a = 1:length(sim5.params.meta_d)
    for b = 1:sim5.params.Nsims
        ...
        % Simulate data
        sim5.data{b,a} = cpc2022_metad_sim(sim5.values{a}.d(b), sim5.values{a}.meta_d(b), sim5.values{a}.c(b), sim5.params.Nratings, sim5.params.Ntrials);
...
% 
% _FUNCTION:_ cpc2022_plot_simVfit(data, data.fit, parameter, model)
% 
% _NOTE:_ parameter = 'meta-d' or 'Mratio'
% 
% _NOTE:_ model = 'single' or 'group' (model used, here it is 'single')

cpc2022_plot_simVfit(sim5, sim5.fit, 'meta-d', 'single');
%% 
% 
% 
% *EXPLANATION:*
...
for a = 1:length(sim6.params.meta_d)
    for b = 1:sim6.params.Nsims
        ...
        sim6.data{b,a} = cpc2022_metad_sim(sim6.params.d, sim6.params.meta_d(a), sim6.params.c, sim6.params.Nratings, sim6.params.Ntrials);
...
cpc2022_plot_simVfit(sim6, sim6.fit, 'meta-d', 'group');
%% 
% 
% 
% *EXPLANATION:*
...
for a = 1:2
    for b = 1:simTwoGroupsI.params.Nsims(a)
        ...
        % Simulate data
        simTwoGroupsI.data{a}.sims{b} = cpc2022_metad_sim(simTwoGroupsI.values{a}.d(b), simTwoGroupsI.values{a}.meta_d(b), simTwoGroupsI.values{a}.c(b), simTwoGroupsI.params.Nratings, simTwoGroupsI.params.Ntrials);
...
for b = 1:simTwoGroupsD.params.Nsims
    ...
    for a = 1:2
        ...
        % Simulate data
        simTwoGroupsD.data{a}.sims{b} = cpc2022_metad_sim(simTwoGroupsD.values{a}.d(b), simTwoGroupsD.values{a}.metad(b), simTwoGroupsD.values{a}.c(b), simTwoGroupsD.params.Nratings, simTwoGroupsD.params.Ntrials);
...
for a = 1:simRegression.params.Nsims
    simRegression.data{a} = cpc2022_metad_sim(simRegression.values.d(a), simRegression.values.meta_d_adjusted(a), simRegression.values.c(a), simRegression.params.Nratings, simRegression.params.Ntrials);
...
cpc2022_plot_simVfit(simRegression, simRegression.fit, 'log(Mratio)', 'regression');
%% 
% 
% 
...
for a = 1:simRC.params.Nsims
    simRC.data{a} = cpc2022_type2_SDT_sim(simRC.values.d(a), simRC.params.noise, simRC.values.c(a), simRC.params.Nratings, simRC.params.Ntrials);
